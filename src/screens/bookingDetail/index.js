...
const BookingDetail = ({ navigation, getuser, SendReturnRequestApi, AddReviewApi, route, singleOrder, CancelBookingApi, UpdatetransactionIdApi, GetOrderByIdApi, GetByProductIdApi }) => {
    ...
    console.log("order detail : ", singleOrder?.orderDetails?.status)
        ...
        <View style={styles.container}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps={'handled'}>
                <OrderCard1
                    ...
                    status={singleOrder?.orderDetails?.status}
                ...
                // onPress={() => GetOrderByIdApi(item._id, navigation, data => setLoader(data))}
                />
                ...
                {arr?.map((item, index) => (
                    <OrderCard1
                        ...
                        // deliveryDate={'Not Available'}
                        paymentMode={singleOrder?.paymentMethod}
                        onPress={() => navigation?.navigate("BookingDetail", { pId: item?._id })}
                ...
                {singleOrder?.orderDetails?.status == "COMPLETED" &&
            ...
            >
                <View style={styles.modalstyle}>
                    <View>
                        <Text style={styles.text6}>{cancel ? "Reason" : "Cancel Booking"}</Text>
