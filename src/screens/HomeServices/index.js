          ...
          <View>
            <FlatList
              ...
              renderItem={({item, index}) => (
                <Services
                  key={index}
                  ml={index == 0 ? SIZES.width * 0.04 : SIZES.width * 0.02}
                  mr={
                    index == getParentCategory?.length - 1
                      ? SIZES.width * 0.04
                      : 0
                  }
                  img={
                    item?.icon ? {uri: http2 + item?.icon} : images?.no_image
                  }
                  text={item?.name}
                  onPress={() => {
