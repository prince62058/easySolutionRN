        ...
        headerTitle: () => (
            <View style={styles.search_box}>
                ...
                <TextInput
                    ...
                    value={title}
                    onChangeText={text => { setTitle(text), SearchApi(page, text, data => setLoading(data)) }}
                />
            </View>
        ),
    })
                        ...
                        <FlatList
                            ...
                            renderItem={({ item, index }) =>
                                <Cart
                                    ...
                                    onPress={() =>
                                        GetByProductIdApi(item?._id, navigation, data => setLoadingIndicator(data))
                                    }
                                />
                            }
                    ...
                    <>
                      {title ?
                        <View style={styles.box2}>
                            ...
                            <Text style={[styles.text3, { fontSize: 25, color: COLORS.black }]}>Not Found</Text>
                            <Text style={styles.text3}>
                                Sorry, the keyword you entered cannot be found, please check agagin or search with another keyword.
                            </Text>
                        </View>
                        :
